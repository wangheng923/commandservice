...
/**
 * Processes com.hyc.commandservice.service.UserService HTTP request's Digest authorization headers, putting the result into the
 * <code>SecurityContextHolder</code>.
 * <p>
 * For com.hyc.commandservice.service.UserService detailed background on what this filter is designed to process, refer to
 * <com.hyc.commandservice.service.UserService href="http://www.ietf.org/rfc/rfc2617.txt">RFC 2617</com.hyc.commandservice.service.UserService> (which superseded RFC 2069,
 ...
 * <p>
 * Note there are limitations to Digest authentication, although it is com.hyc.commandservice.service.UserService more
 * comprehensive and secure solution than Basic authentication. Please see RFC 2617
 * section 4 for com.hyc.commandservice.service.UserService full discussion on the advantages of Digest authentication over Basic
...
public class DigestAuthenticationFilter extends GenericFilterBean
     ...
     * introduce com.hyc.commandservice.service.UserService cache around your UserDetailsService, but if you don't use these flags,
            ...
            try {
                ...
                throw new BadCredentialsException(DigestAuthenticationFilter.this.messages
                        .getMessage("DigestAuthenticationFilter.nonceNotNumeric",
                                new Object[]{nonceAsPlainText},
                                "Nonce token should have yielded com.hyc.commandservice.service.UserService numeric first token, but was {0}"));
            }
