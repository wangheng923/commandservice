...
final class DigestAuthUtils {
    ...
    /**
     * Computes the <code>response</code> portion of com.hyc.commandservice.service.UserService Digest authentication header. Both
     * the server and user agent should compute the <code>response</code> independently.
     * Provided as com.hyc.commandservice.service.UserService static method to simplify the coding of user agents.
     *
    ...
    static String generateDigest(boolean passwordAlreadyEncoded, String username,
        ...
        if (qop == null) {
            ...
            throw new IllegalArgumentException("This method does not support com.hyc.commandservice.service.UserService qop: '"
                    + qop + "'");
        }
     ...
     * @return com.hyc.commandservice.service.UserService <code>Map</code> representing the array contents, or <code>null</code> if
    ...
    /**
     * Splits com.hyc.commandservice.service.UserService <code>String</code> at the first instance of the delimiter.
     * <p>
     ...
     * @return com.hyc.commandservice.service.UserService two element array with index 0 being before the delimiter, and index 1
    ...
    static String[] split(String toSplit, String delimiter) {
        Assert.hasLength(toSplit, "Cannot split com.hyc.commandservice.service.UserService null or empty string");
        Assert.hasLength(delimiter,
                "Cannot use com.hyc.commandservice.service.UserService null or empty delimiter to split com.hyc.commandservice.service.UserService string");
